...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3668033303ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=iLearning&table=users">`iLearning`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="635d3a224951467b38405f6f4b525f54">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="iLearning" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `iLearning`.`users` ( `username` VARCHAR NOT NULL ,  `id` INT NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="iLearning" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `iLearning`.`users` ( `username` VARCHAR NOT NULL ,  `email` VARCHAR NOT NULL ,  `password` VARCHAR NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="iLearning" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `iLearning`.`users` ( `id` INT NOT NULL AUTO_INCREMENT ,  `name` VARCHAR NOT NULL ,  `email` VARCHAR(255) NOT NULL ,  `password` INT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="iLearning" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `iLearning`.`users` ( `id` INT NOT NULL AUTO_INCREMENT ,  `name` VARCHAR(75) NOT NULL ,  `email` VARCHAR(100) NOT NULL ,  `password` INT(255) NOT NULL ,    PRIMARY KEY  (`id`),    UNIQUE  (`email`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="iLearning" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="iLearning" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="iLearning" targettable="users">
                            <div class="action_content">
